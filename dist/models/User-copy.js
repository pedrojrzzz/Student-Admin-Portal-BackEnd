...
var User = exports["default"] = /*#__PURE__*/function (_Model) {
  function User() {
  ...
  return _createClass(User, [{
    ...
    value: function init(sequelize) {
      _get(_getPrototypeOf(User), "init", this).call(this, {
        ...
        hooks: {
          beforeSave: function () {
            var _beforeSave = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(user) {
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    console.log('BeforeSave Hook Executed');
            ...
            function beforeSave(_x) {
              return _beforeSave.apply(this, arguments);
            }
            return beforeSave;
          }()
        }
