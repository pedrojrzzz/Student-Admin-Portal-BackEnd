...
function () {
  ...
  _createClass(AlunoController, [{
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return _regeneratorRuntime().awrap(_Alunos["default"].findAll({
    ...
    value: function show(req, res) {
      var id, aluno;
      return _regeneratorRuntime().async(function show$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 4:
              _context2.next = 6;
              return _regeneratorRuntime().awrap(_Alunos["default"].findByPk(id, {
                attributes: ['id', 'nome', 'sobrenome', 'email', 'idade', 'peso', 'altura'],
                order: [['id', 'DESC'], [_Fotos["default"], 'id', 'DESC']],
                include: {
                  model: _Fotos["default"],
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _context3.next = 3;
              return _regeneratorRuntime().awrap(_Alunos["default"].create(req.body));
            case 3:
      ...
      return _regeneratorRuntime().async(function update$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 8:
              _context4.next = 10;
              return _regeneratorRuntime().awrap(_Alunos["default"].update(req.body, {
                where: {
                  id: id
                }
              }));
      ...
      return _regeneratorRuntime().async(function _delete$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 9:
              _context5.next = 11;
              return _regeneratorRuntime().awrap(_Alunos["default"].destroy({
                where: {
                  id: id
                }
              }));
