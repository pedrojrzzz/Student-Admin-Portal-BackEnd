...
function () {
  ...
  _createClass(UserController, [{
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return _regeneratorRuntime().awrap(_User["default"].create(req.body));
            case 4:
    ...
    value: function index(req, res) {
      var users;
      return _regeneratorRuntime().async(function index$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return _regeneratorRuntime().awrap(_User["default"].findAll({
    ...
    value: function show(req, res) {
      var user;
      return _regeneratorRuntime().async(function show$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _context3.next = 3;
              return _regeneratorRuntime().awrap(_User["default"].findByPk(req.params.id, {
                attributes: ['id', 'nome', 'email']
              }));
            case 3:
              user = _context3.sent;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.prev = 0;
              _context4.next = 3;
              return _regeneratorRuntime().awrap(_User["default"].findByPk(req.userId));
            case 3:
              user = _context4.sent;
              if (user) {
                _context4.next = 6;
            ...
            case 6:
              _context4.next = 8;
              return _regeneratorRuntime().awrap(_User["default"].update(req.body, {
                where: {
                  id: req.userId
                }
              }));
      ...
      return _regeneratorRuntime().async(function _delete$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 6:
              _context5.next = 8;
              return _regeneratorRuntime().awrap(_User["default"].destroy({
                where: {
                  id: req.userId
                }
              }));
