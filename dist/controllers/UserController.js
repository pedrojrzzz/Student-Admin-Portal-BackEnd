...
var UserController = /*#__PURE__*/function () {
  ...
  return _createClass(UserController, [{
    ...
    key: "index",
    value: (function () {
      var _index = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
        var users;
    ...
    key: "show",
    value: (function () {
      var _show = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
        var user;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _context3.next = 3;
              return _User["default"].findByPk(req.params.id, {
                attributes: ['id', 'nome', 'email']
              });
            case 3:
              user = _context3.sent;
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.prev = 0;
              _context4.next = 3;
              return _User["default"].findByPk(req.userId);
            case 3:
              user = _context4.sent;
              if (user) {
                _context4.next = 6;
            ...
            case 6:
              _context4.next = 8;
              return _User["default"].update(req.body, {
                where: {
                  id: req.userId
                }
              });
